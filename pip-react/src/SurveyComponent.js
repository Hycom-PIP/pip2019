                                                ...
                                                <MDBCol>
                                                        {
                                                                (this.state.survey.pageList[this.state.currentPage - 1].questionList || []).map(
                                                                        (question, value) =>
                                                                                (
                                                                                        <QuestionCard key={this.state.currentPage + '.' + value} parentKey={this.state.currentPage + '.' + value} data={question} index={value} func={this.questionDataChange} dltFunc={this.deleteQuestion} multiDltfunc={this.deleteMultiQuestion} moveFunc={this.moveQuestion} />
                                                                                )
                                                                )
